...
void ZoomVideoSDKVirtualAudioSpeaker::onVirtualSpeakerMixedAudioReceived(
    AudioRawData *data_) {
...
void ZoomVideoSDKVirtualAudioSpeaker::onVirtualSpeakerOneWayAudioReceived(
    AudioRawData *data_, IZoomVideoSDKUser *pUser) {
...
void ZoomVideoSDKVirtualAudioSpeaker::onVirtualSpeakerSharedAudioReceived(
    AudioRawData *data_) {
